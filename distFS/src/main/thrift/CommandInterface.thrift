...
service CommandInterface{
	...
	int DeleteFile(1:string fileID); 								#Any client to Master
	...
	void GetFile(1:string filename) 								#Client to node with a copy of the file
	void FileStorageAck(1:string filename, 2:string incomingID) 	#Node to Master after copy is made
	void RequestFileReport(1:string receiverIp) 					#Master to NodeManager
	void RequestFileCopy(1:string filename, 2:string nodeID)	#Replica Manager to Node containing file	
